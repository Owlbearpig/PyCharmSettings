...
class Variables():
    ...
    def __init__(self):
        ...
        self.disc_dict = {"232637566539530242": ("Endavar", "Defias Brotherhood"), "105605803632762880": ("Rushb", "Defias Brotherhood"),
        ...
        self.raider_io_base_url = "https://raider.io/api/v1/characters/profile?region=eu&realm={1}&name={0}&fields={2}"
